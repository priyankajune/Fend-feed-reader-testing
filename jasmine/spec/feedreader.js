    ...
    */
    ...
    describe('The menu',function(){
        ...
        it('display and hide menu on click',function(){
            ...
            expect($('body').hasClass('menu-hidden')).toBe(false);   //display menu
            $('.menu-icon-link').click();
    ...
    describe('New Feed Selection',function(){
        ...
        loadFeed(1,function(){     // meeting async function demands
            $feed_new = $('.header-title').html();
            done();
            });
        });
    });
    //feed change
    it('change feed on load',function(){
        expect(feed).not.toEqual(feed_new);  // ensure feed and new_feed are different
        });
    });
}());
